...
default_win=15
default_bilatfil=1
folders_dms=['../data/deepmag/momag-database/moveOnly2_downsize_4/',           
           '../data/deepmag/momag-database/moveOnly2_downsize_4_halfMag/']           
folders_results=['../data/proposedResults/from_DMS/default/moveOnly2_downsize_4/',           
           '../data/proposedResults/from_DMS/default/moveOnly2_downsize_4_halfMag/']
folders_best=['../data/proposedResults/from_DMS/best/moveOnly2_downsize_4/',
           '../data/proposedResults/from_DMS/best/moveOnly2_downsize_4_halfMag/']
...
for pnum, path_dms in enumerate(folders_dms): 
    ...
    dms=[v for v in videos if v.startswith('orig')]
    dms.sort(key=getNum)
    ...
    for i,dmsv in enumerate(dms):
        ...
        out_name=folders_results[pnum]+'v'+str(i)+'_fromDMS'+DMS_settings+'_default.mp4'
        sfm_metrics_file='./csvs/'+'SFM_metrics_{}_v{}.csv'.format(DMS_settings,i)
        alpha_2=1
        ...
        for s in scale_range:
            for b in bilatfil_size_range:
                for w in winsize_range:
                    ...
                    sfm_metrics_file='./tmp/'+'SFM_best_metrics_{}_v{}_s{}_b{}_w{}.csv'.format(DMS_settings,i,s,b,w)
