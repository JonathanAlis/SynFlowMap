...
default_win=15
default_bilatfil=1
folders_acc=['../data/deepmag/momag-database/moveHalfLarge_downsize_4/',           
             '../data/deepmag/momag-database/moveHalfLarge_downsize_4_halfMag/']           
folders_results=['../data/proposedResults/from_ACC/default/moveHalfLarge_downsize_4/',           
                 '../data/proposedResults/from_ACC/default/moveHalfLarge_downsize_4_halfMag/']
folders_best=['../data/proposedResults/from_ACC/best/moveHalfLarge_downsize_4/',
              '../data/proposedResults/from_ACC/best/moveHalfLarge_downsize_4_halfMag/']
...
for pnum, path_acc in enumerate(folders_acc): 
    ...
    acc=[v for v in videos if v.startswith('orig')]
    acc.sort(key=getNum)
    ...
    for i,accv in enumerate(acc):
        ...
        sfm_metrics_file='./csvs/'+'SFM_metrics_{}_v{}.csv'.format(ACC_settings,i)
        alpha_2=1
        ...
        for s in scale_range:
            for b in bilatfil_size_range:
                for w in winsize_range:
                    ...
                    sfm_metrics_file='./tmp/'+'SFM_best_metrics_{}_v{}_s{}_b{}_w{}.csv'.format(ACC_settings,i,s,b,w)
